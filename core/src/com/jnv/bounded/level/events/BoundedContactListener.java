...
public class BoundedContactListener implements ContactListener {
	...
	public boolean isTouchingBlackHole() {
		return !allBlackHoles.isEmpty();
	}

	public boolean isTouchingBlackHoleCenter() {
		return isTouchingBlackHoleCenter;
	}

	public boolean isTouchingFan() {
		return !allFans.isEmpty();
	}

	public boolean isTouchingGumCloud() {
		return numGumCloudContacts > 0;
	}

	public boolean isTouchingKey() {
		return isTouchingKey;
	}

	public boolean isTouchingMagnet() {
		return !allMagnets.isEmpty();
	}

	public boolean isTouchingPortal() {
		return numPortalContacts > 0;
	}

	public boolean isTouchingTeleporter() {
		return !allTeleporters.isEmpty();
	}
	...
	public List<Body> getAllBlackHoles() {
		return allBlackHoles;
	}

	public List<Body> getAllFans() {
		return allFans;
	}

	public List<Body> getAllMagnets() {
		return allMagnets;
	}

	public List<Body> getAllTeleporters() {
